/**
 * FORAGE — DuoPlanInfoSheet
 * app/_duo-plan-info-sheet.tsx
 *
 * Compact bottom-sheet shown when the user taps the Duo Plans row on the
 * Friends tab. Same visual/motion pattern as _end-outing-confirm-sheet.tsx
 * (slide-up sheet, 300ms ease-out, backdrop fade) — but unlike that sheet,
 * this one is purely informational, not a data-loss warning, so the
 * backdrop is tappable and dismisses it the same way the "Got it" button
 * does.
 */
